...
int main(int, char**)
{
...
#endif
    {
        ...
        ImGui::Begin("Sum", NULL, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize);
        if(ImGui::Button("Create"))
        {
            diagram_add_component(&diagram, add_title, 10, 10, add_input_labels, add_output_labels, NULL, 2, 0, 1, add);
        }
        ImGui::End();

        ImGui::Begin("Source", NULL, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize);
        if(ImGui::Button("Create"))
        {
            diagram_add_component(&diagram, number_source_title, 10, 10, NULL, number_source_output_labels, number_source_parameter_labels, 0, 1, 1, number_source);
        }
        ImGui::End();

        ImGui::Begin("Sink", NULL, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize);
        if(ImGui::Button("Create"))
        {
            diagram_add_component(&diagram, sink_title, 10, 10, sink_input_labels, NULL, NULL, 1, 0, 0, nop);
        }
        ImGui::End();
